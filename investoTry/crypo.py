...
def crypto_get_model(curr1):
    url = f'https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_DAILY&symbol={curr1}&market=INR&apikey=PRSVB5B7LKOVVNAV&datatype=csv'
...
crypto_to_try = ['BTC','ETH','XRP', 'BCH', 'XLM']
for a in crypto_to_try:
    x,y,z,j = crypto_predict_graph(curr1 = a)
    print(j)
