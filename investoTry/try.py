...
def stock_predict_graph(stock='IOC.BSE', pred_days=5):
    ...
    if models.get(stock) is None:
        ...
        models[stock] = {'model':current_model,'r2':r2, 'history_graph':history_graph, 'initial_x':initial_x, 'compare_graph':compare_graph, 'dataset_min':dataset_min, 'datset_max':dataset_max}
    else:
...
stocks_to_try = ['LT.BSE', 'LTI.BSE', 'INFY.BSE', 'CIPLA.BSE', 'BA', 'GOOG']
for a in stocks_to_try:
    x,y,z,j = stock_predict_graph(a)
    print(j)